...
import type { Comment as _Comment, ExternalBlob as _ExternalBlob, Post as _Post, Time as _Time, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createPost(arg0: string, arg1: ExternalBlob): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createPost(arg0, await to_candid_ExternalBlob_n10(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getProfile(arg0: Principal): Promise<PublicProfile> {
        if (this.processError) {
            try {
    ...
    async searchProfiles(arg0: string): Promise<Array<PublicProfile>> {
        if (this.processError) {
            try {
